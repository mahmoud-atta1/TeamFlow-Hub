...
**TeamFlow Hub** is a robust backend API for managing teams, tasks, and workflows with three distinct user roles. Built with **Node.js**, **Express**, and **MongoDB**, it provides a complete RESTful API with JWT authentication and real-time notfications via Socket.IO
